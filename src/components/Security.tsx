...
export default function Security() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            navigate('/'); // пароль поставлен, юзер уже залогинен сервером
        } catch (err: any) {
