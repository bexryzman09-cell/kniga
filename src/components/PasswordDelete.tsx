                            ...
                            <form className='flex flex-col max-w-sm gap-2.5'>
                                <label className='flex flex-col gap-2'>
                                    ...
                                    <div className='flex  mb-9 items-center   rounded-[14px] border bg-white border-[#d6dbe1]'>
                                        ...
                                        <input className='w-full mt-2 min-w-72 p-1    outline-none mb-1.75'
                                            type="tel" maxLength={13} pattern="^\+998\d{9}$" required   ></input>
                                    </div>
                                </label>


                                <button className='w-full mb-2 max-w-85  p-3.25 rounded-[14px] bg-[#db5300] text-white   font-semibold '>Продольжить</button>
