                        ...
                        <div className='pt-15 p-30 rounded-b-2xl rounded-tr-2xl  pb-38.5 shadow-[0_5px_20px_0_rgba(214,219,225,0.4)]'>
                            ...
                            <form className='flex flex-col max-w-sm gap-2.5'>
                                <label className='flex flex-col gap-2'>
                                    Введите ваше имя:
                                    <input className='w-full min-w-85 p-3 rounded-[14px] border border-[#d6dbe1] bg-white outline-none mb-1.75'
                                        type="text" placeholder=" Введите ваше имя:" required   ></input>
                                </label>
                                <label className='flex flex-col gap-2'>
                                    Введите свою фамилию:
                                    <input className='w-full min-w-85 p-3 rounded-[14px] border border-[#d6dbe1] bg-white outline-none mb-1.75'
                                        type="text" placeholder=" Введите свою фамилию:" required   ></input>
                                </label>
                                <label className='flex flex-col gap-2'>
                                    Ваш номер телефона:
                                    <input className='w-full min-w-85 p-3 rounded-[14px] border border-[#d6dbe1] bg-white outline-none mb-1.75'
                                ...
                                <button className='w-full cursor-pointer max-w-85  p-3.25 rounded-[14px] bg-[#db5300] text-white   font-semibold '>Продольжить</button>
                            </form>
                        </div>
                    </div>
                </div>
